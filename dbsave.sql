...
INSERT INTO `pothole` (`id`, `location`, `reports_count`, `created_at`, `active`) VALUES
...
CREATE TABLE `report` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `pothole_id` (`pothole_id`),
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`pothole_id`) REFERENCES `pothole` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `report` (`id`, `location`, `device_uuid`, `pothole_id`, `additional_data`, `created_at`) VALUES
